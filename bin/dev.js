...
module.exports = () => {
  choosePort(HOST, DEFAULT_PORT)
    .then(port => {
      ...
      const compiler = customCompiler(webpack, config, appName, urls, useYarn)
      // Load proxy config
...
function customCompiler(webpack, config, appName, urls, useYarn) {
  try {
  ...
  compiler.plugin('invalid', () => {
    console.clear()
    console.log(chalk.default.blueBright('Restory Compiling...'))
  })
